...
static inline int calcPlayerRoundScore(char opponentChar, char desiredOutcome)
{
    int score = 0;
    int outcomeScore = 0;
    char playerChar = 'a';

    // calculate what the player's play should be
    ...
    case DesiredOutcomes::Lose:
        ...
        case OpponentChars::Rock:
            playerChar = PlayerChars::Scissors;
            break;
        case OpponentChars::Paper:
            playerChar = PlayerChars::Rock;
            break;
        case OpponentChars::Scissors:
            playerChar = PlayerChars::Paper;
            break;
        default:
            break;
        }
    ...
    // calcaulte the score based on the opponent and player's plays
    switch (opponentChar)
    {
    case OpponentChars::Rock:
        switch (playerChar)
...
int main()
{
    if (runGameStrategy(testInput) != 12) {
        printf("Test failed\n");
    }
    printf("test passed\n");
